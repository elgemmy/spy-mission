...
landing page ("Spymaster Mission", design source: Claude Design project
`Awesome Codenames` → `Spymaster Mission Landing.html`, mirrored under
`docs/handoff/landing/`). Requirements:

1. The base domain (`spymaster.<host>`) is reserved for the landing page.
