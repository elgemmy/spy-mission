...
describe("absolutePlayUrl", () => {
  it("prefixes the origin", () => {
    expect(absolutePlayUrl("https://spymaster.example.com")).toBe(
      "https://spymaster.example.com/play/",
    );
  });

  it("carries options through", () => {
    expect(
      absolutePlayUrl("https://spymaster.example.com", { room: "abc12" }),
    ).toBe("https://spymaster.example.com/play/?room=ABC12");
  });
...
describe("playHostLabel", () => {
  it("appends the play path without a trailing slash", () => {
    expect(playHostLabel("spymaster.example.com")).toBe(
      "spymaster.example.com/play",
    );
  });
